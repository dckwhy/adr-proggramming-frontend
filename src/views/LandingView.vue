...
onMounted(async () => {
  await userInfoStore.getUserDevice()
  await userInfoStore.getUserIp()
  await userInfoStore.getUserScreenSize()
  await userInfoStore.storeUserInfo()
})
            ...
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div>
                ...
                <p class="mt-4 text-lg text-blueGray-200">
                  Menyediakan jasa pembuatan aplikasi berbasis website, desktop dan atau mobile untuk semua kebutuhan
                  anda.
                </p>
              </div>
            </div>
      ...
      <section class="pb-20 bg-blueGray-200 -mt-24">
        <div class="container mx-auto px-4">
          <div class="flex md:flex-row flex-col">
            <div class="w-full md:w-1/4 px-4 text-center">
              <div class="relative flex flex-auto flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto">
                  ...
                  <p class="mt-2 mb-4 text-blueGray-500">
                    Gratis perbaikan sistem jika ada yang tidak sesuai.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="w-full md:w-1/4 px-4 text-center">
              <div class="relative flex flex-auto flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Fast Response</h6>
                  <p class="mt-2 mb-4 text-blueGray-500">
                    Respon secepat yang kami bisa.
                  <p><br></p>
                  </p>
                </div>
              </div>
            ...
            <div class="w-full md:w-1/4 px-4 text-center">
              <div class="relative flex-auto flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto">
                  <div
                    class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-lightBlue-400">
                    <i class="fa-solid fa-star"></i>
                  </div>
                  <h6 class="text-xl font-semibold">Best Quality</h6>
                  <p class="mt-2 mb-4 text-blueGray-500">
                    Selalu memberikan kualitas terbaik dalam melayani client.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="w-full md:w-1/4 px-4 text-center">
              <div class="relative flex-auto flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Fee Flexibility</h6>
                  <p class="mt-2 mb-4 text-blueGray-500">
                    Budget menyesuaikan kantong client.
                  </p>
                </div>
              </div>
            </div>

  ...
  <nav class="top-0 absolute z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg">
    <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
      <div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
        <router-link
          class="text-white text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase" to="/">
          <!-- <div class="w-16 h-16 rounded-full overflow-hidden"> -->
          <img :src="imgUrl()" alt="" class="w-auto h-12">
          <!-- </div> -->
        </router-link>
        <button
      ...
      <div class="lg:flex flex-grow items-center bg-white lg:bg-opacity-0 lg:shadow-none"
        ...
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          <li class="flex items-center">
            <router-link to="/metode-pembayaran"
              class="lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold">
              Metode Pembayaran
            </router-link>
          </li>
          <li class="flex items-center">
            <router-link to="/faq-bisnis"
              class="lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold">
              FAQ Bisnis
            </router-link>
          </li>
          <li class="flex items-center">
            <router-link to="/faq-joki"
              class="lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold">
              FAQ Joki
            </router-link>
          </li>
          <li class="flex items-center">
            <a class="lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
              href="https://web.facebook.com/Ghuss.Ciblex" target="_blank">
          ...
          <li class="flex items-center">
            <a class="lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
              href="https://www.instagram.com/adr_programming/" target="_blank">
              <i class="lg:text-blueGray-200 text-blueGray-400 fab fa-instagram text-lg leading-lg" />
...
export default {
  ...
  methods: {
    ...
    imgUrl: function () {
      return new URL('@/assets/navbar-brand.png', import.meta.url).href
    }
  },
  components: {
    PagesDropdown,
